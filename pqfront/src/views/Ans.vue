...
onMounted(async () => {
  ...
  id: q.id,
  question: q.content, // 数据库字段 text
  options: [q.optionA, q.optionB, q.optionC, q.optionD], // 数据库字段 ansa, ansb, ...
  answer: q.correctIndex// correct 是 A/B/C/D，转成 0/1/2/3
}))
...
.option-btn {
  ...
  padding: 0 12px;          /* 增加左右内边距防止贴边 */
  line-height: 1.4;         /* 行高适当 */
}
.actions {
  display: flex;
