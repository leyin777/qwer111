...
// 2. 构造 multipart/form-data
        ...
        for (Map<String, Object> q : questions) {
            ...
            question.setQid(qid.longValue());
            question.setText((String) q.get("stem"));
            question.setAnsa((String) q.get("A"));
            question.setAnsb((String) q.get("B"));
            question.setAnsc((String) q.get("C"));
            question.setAnsd((String) q.get("D"));
            question.setCorrect((String) q.get("correct"));
